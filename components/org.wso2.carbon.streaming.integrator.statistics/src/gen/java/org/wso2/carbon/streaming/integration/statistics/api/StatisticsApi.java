 ...
 *
 */
package org.wso2.carbon.streaming.integration.statistics.api;
...
public class StatisticsApi implements Microservice   {
     ...
     * @throws org.wso2.carbon.streaming.integration.statistics.api.NotFoundException
     */
    @GET
    ...
    public Response statisticsGet(
            ...
            throws NotFoundException, org.wso2.carbon.streaming.integration.statistics.api.NotFoundException {
